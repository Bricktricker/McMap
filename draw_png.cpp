...
namespace draw {
	...
	void setSnow(const size_t x, const size_t y, const Color_t& color, image::PNGWriter* pngWriter);
	void setTorch(const size_t x, const size_t y, const Color_t& color, image::PNGWriter* pngWriter);
	void setFlower(const size_t x, const size_t y, const Color_t& color, image::PNGWriter* pngWriter);
	void setRedwire(const size_t x, const size_t y, const Color_t& color, image::PNGWriter* pngWriter);
	void setFire(const size_t x, const size_t y, const Color_t& color, const Color_t& light, const Color_t& dark, image::PNGWriter* pngWriter);
	void setGrass(const size_t x, const size_t y, const Color_t& color, const Color_t& light, const Color_t& dark, const int sub, image::PNGWriter* pngWriter);
	void setFence(const size_t x, const size_t y, const Color_t& color, image::PNGWriter* pngWriter);
	void setStep(const size_t x, const size_t y, const Color_t& color, const Color_t& light, const Color_t& dark, image::PNGWriter* pngWriter);
	void setUpStep(const size_t x, const size_t y, const Color_t& color, const Color_t& light, const Color_t& dark, image::PNGWriter* pngWriter);
#define setRailroad setSnowBA
	...
	void setSnowBA(const size_t x, const size_t y, const Color_t& color, image::PNGWriter* pngWriter);
	void setTorchBA(const size_t x, const size_t y, const Color_t& color, image::PNGWriter* pngWriter);
	void setFlowerBA(const size_t x, const size_t y, const Color_t& color, image::PNGWriter* pngWriter);
	void setGrassBA(const size_t x, const size_t y, const Color_t& color, const Color_t& light, const Color_t& dark, const int sub, image::PNGWriter* pngWriter);
	void setStepBA(const size_t x, const size_t y, const Color_t& color, const Color_t& light, const Color_t& dark, image::PNGWriter* pngWriter);
	void setUpStepBA(const size_t x, const size_t y, const Color_t& color, const Color_t& light, const Color_t& dark, image::PNGWriter* pngWriter);
	...
	*/
	void setPixel(const int x, const int y, const uint16_t stateID, const float fsub, image::PNGWriter* pngWriter){
		...
		Color_t currentColor = Global::colorMap[stateID];
...
#define BLEND(ca,aa,cb) Channel(((size_t(ca) * size_t(aa)) + (size_t(255 - aa) * size_t(cb))) / 255)
	...
	void setGrass(const size_t x, const size_t y, const Color_t& color, const Color_t& light, const Color_t& dark, const int sub, image::PNGWriter* pngWriter)
	{
		...
		Color_t L = Global::colorMap[Global::blockTree["minecraft:dirt"].get()];
		Color_t D = L;
		L = modColor(L, sub - 15);
		D = modColor(D, sub - 25);
		// consider noise
